    ...
    return (
        <div className="fixed  inset-0 bg-gray-800 bg-opacity-75 flex justify-center items-center  ">
          <div className="bg-white w-max p-4 rounded-lg h-36 grid gap-6 ">
             <p className='font-semibold text-lg px-4'>Do you want to close the registration for this  bootcamp?</p>
             <p className='w-full flex space-x-4'>
                <button className='w-full py-2 bg-red-500 border-2 border-red-500 hover:bg-red-400 text-white rounded-md' onClick={()=>closeregistration()}>Yes</button>
